import { PrivateKey, PublicKey, Signature } from './leopaysjs-jssig';
import { generateKeyPair } from './leopaysjs-key-conversions';
...
export const ecc = {
  ...
  sha256: (data: string | Buffer, resultEncoding?: string, encoding?: string): string | Buffer => {
    ...
    return require('./leopaysjs-key-conversions').sha256(data);
  }
};
