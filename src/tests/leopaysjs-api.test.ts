...
describe('leopaysjs-api', () => {
  ...
  it('getAbi returns an abi', async () => {
    const response = await api.getAbi('testlpctoken');
  ...
  it('getContract returns a contract', async () => {
    const response = await api.getContract('testlpctoken');
  ...
  it('rawAbiToJson returns correct Json from raw Abi', async () => {
    const expected = await api.getAbi('testlpctoken');
    const response = await rpc.getRawAbi('testlpctoken');
  ...
  it('jsonToRawAbi returns correct raw Abi from Json', async () => {
    ...
    const jsonAbi = await api.getAbi('testlpctoken');
  ...
  it('confirms jsonToRawAbi and rawAbiToJson are reciprocal', async () => {
    const expectedJsonAbi = await api.getAbi('testlpctoken');
    const response = await rpc.getRawAbi('testlpctoken');
