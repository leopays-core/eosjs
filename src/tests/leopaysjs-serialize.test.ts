...
import { createInitialTypes, Type, SerialBuffer } from '../leopaysjs-serialize';
...
describe('Serialize', () => {
  ...
  describe('pushAsset', () => {
    ...
    it('should be able to push asset with valid LPC symbol "10.000 LPC"', () => {
      const asset = '10.000 LPC';
    ...
    it('should not be able to push invalid lowercase symbol "10.000 lpc"', () => {
      const asset = '10.000 lpc';

      expectExceptionThrown(asset);
    });

    it('should not be able to push two symbols "10.000 LPC blah"', () => {
      const asset = '10.000 LPC blah';
